          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow-md border border-sky-100">
              ...
              <p className="text-slate-700 mb-4">
                "Esta plataforma me ayudó a elegir los mejores profesores para mi carrera. Las reseñas son muy útiles y
                precisas."
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-sky-100">
              ...
              <p className="text-slate-700 mb-4">
                "Gracias a las reseñas pude evitar profesores con malas evaluaciones y elegir los que mejor se adaptan a
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-sky-100">
              ...
              <p className="text-slate-700 mb-4">
                "Una herramienta indispensable para todo estudiante universitario. Me ha ayudado a planificar mejor mis
                semestres."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-sky-100 rounded-full flex items-center justify-center text-sky-700 font-medium">
